...
<div class="max-w-4xl mx-auto px-4 py-8 md:py-16">
	...
	<div class="card space-y-8 text-terminal-text">
		...
		<section>
			...
			<p>
				Anbieter ist die netcup GmbH. Details entnehmen Sie der Datenschutzerklärung des Anbieters:
				<a
					href="https://www.netcup.com/de/kontakt/datenschutzerklaerung"
					target="_blank"
					rel="noopener noreferrer"
					class="text-terminal-blue hover:underline"
		...
		<section>
			...
			<h3 class="text-xl font-semibold mt-6 mb-2">Hinweis zur verantwortlichen Stelle</h3>
			...
			<p class="mt-4">E-Mail: hallo@marco-kretz.de</p>
		</section>
